...
func InitDB() {
	...
	// Auto-migrate models.
	if err = DB.AutoMigrate(&models.Review{}, &models.Wishlist{}); err != nil {
		log.Fatalf("Failed to auto-migrate models: %v", err)
	}

	log.Println("✅ Review Service Database connected successfully")
}
...
func CloseDB() {
	...
	log.Println("✅ Review Service Database connection closed")
}
