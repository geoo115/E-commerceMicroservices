...
type InventoryServiceClient interface {
	...
	UpdateStock(ctx context.Context, in *UpdateStockRequest, opts ...grpc.CallOption) (*InventoryResponse, error)
}
...
func (c *inventoryServiceClient) UpdateStock(ctx context.Context, in *UpdateStockRequest, opts ...grpc.CallOption) (*InventoryResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(InventoryResponse)
...
type InventoryServiceServer interface {
	...
	UpdateStock(context.Context, *UpdateStockRequest) (*InventoryResponse, error)
...
func (UnimplementedInventoryServiceServer) UpdateStock(context.Context, *UpdateStockRequest) (*InventoryResponse, error) {
