...
type OrderServiceClient interface {
	...
	DeleteOrder(ctx context.Context, in *DeleteOrderRequest, opts ...grpc.CallOption) (*DeleteResponse, error)
}
...
func (c *orderServiceClient) DeleteOrder(ctx context.Context, in *DeleteOrderRequest, opts ...grpc.CallOption) (*DeleteResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type OrderServiceServer interface {
	...
	DeleteOrder(context.Context, *DeleteOrderRequest) (*DeleteResponse, error)
...
func (UnimplementedOrderServiceServer) DeleteOrder(context.Context, *DeleteOrderRequest) (*DeleteResponse, error) {
