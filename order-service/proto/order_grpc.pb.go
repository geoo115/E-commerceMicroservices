...
//
// OrderService defines the order operations.
type OrderServiceClient interface {
	...
	DeleteOrder(ctx context.Context, in *GetOrderRequest, opts ...grpc.CallOption) (*OrderResponse, error)
...
func (c *orderServiceClient) DeleteOrder(ctx context.Context, in *GetOrderRequest, opts ...grpc.CallOption) (*OrderResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(OrderResponse)
...
type OrderServiceServer interface {
	...
	DeleteOrder(context.Context, *GetOrderRequest) (*OrderResponse, error)
...
func (UnimplementedOrderServiceServer) DeleteOrder(context.Context, *GetOrderRequest) (*OrderResponse, error) {
